...
USCITA = 'lavoro/fase5-db_item-007.jsonl'
RIGHE = {
    48808, 49711, 52173, 52316, 66140, 69051, 69121, 69191, 82216, 82613,
    89422, 117321, 128176, 128308, 128378, 128448, 128518, 128588, 128658, 128728,
    128798,
}
