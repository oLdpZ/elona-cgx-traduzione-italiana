...
USCITA = 'lavoro/fase4-tcg_mod-001.jsonl'
DA, A = 0, 9999
SORGENTE = r'C:\\Games\\Elona\\_traduzione\\sorgente\\2.05-custom-gx\\tcg_mod.hsp'

tutte = [json.loads(l) for l in io.open('lavoro/_tcg_mod.jsonl', encoding='utf-8') if l.strip()]
