# -*- coding: utf-8 -*-
"""124a - Rimonta `RIPRESA-sessione.md`: testa nuova, la 123a in storia.

    PYTHONIOENCODING=utf-8 PYTHONPATH=. python scratchpad/_124-riscrivi-ripresa.py
...
titolo. La lista di collaudo dei lotti 070-077, che la 123a aveva messo fra la
testa e le sezioni perenni, scende insieme a lei: e' roba sua.
...
CONFINE_STORIA = '## La centoventiduesima sessione'
TITOLO_STORIA = '## La centoventitreesima sessione (per storia)'
