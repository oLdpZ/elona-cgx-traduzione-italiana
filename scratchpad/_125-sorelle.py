# -*- coding: utf-8 -*-
"""125a - Per ogni firma di un lotto, cerca il
giapponese piu' somigliante in TUTTO il dizionario e stampa come e' gia' reso.

    PYTHONIOENCODING=utf-8 python scratchpad/_125-sorelle.py <lotto.jsonl>
...
LOTTO = os.path.join(QUI, __import__('sys').argv[1]) if len(__import__('sys').argv)>1 else os.path.join(QUI, '_124-itemench.jsonl')
SOGLIA = 0.75
