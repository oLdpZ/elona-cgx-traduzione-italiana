...
| `Arena` | **parola italiana identica all'inglese**, e viene dallo stesso latino. È l'undicesima voce di `rankn(10, 0)` (`init.hsp:355`), cioè **il nome della categoria** e non un gradino di rango: `module.hsp:264` la legge per scrivere «Cambio di rango (Arena 5° → 4°)». Le altre dieci voci della riga sono tradotte. ⚠️ Il gemello 「ペットアリーナ」 **non** sta qui: quello diventa «Arena delle bestie», il termine già fissato da `db_creature.hsp:118259` |
