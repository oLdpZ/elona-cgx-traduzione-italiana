...
DICHIARATI: dict[str, Dichiarazione] = {
    ...
    "command.hsp": Dichiarazione(
        "esente", 1,
        "⭐⭐ ERA 3 FINO ALLA 141ª, e le due che sono uscite sono «god inside» e "
        "«man inside» (:4481, :4485), i due `instr` scherzosi su 中の神 e 中の人. "
        "La 142ª ha preso la decisione sulla battuta che mancava, e non "
        "inventando una parola: la risposta dice gia' «Dev'essere dura per il "
        "**dio dentro**» e «per la **persona dentro**», quindi la chiave e' "
        "quella, e si e' AGGIUNTA in `or` accanto al giapponese e all'inglese "
        "invece di sostituirli — la stessa regola che "
        "`genera_toppe_desideri.py` applica alle parole del desiderio, e questi "
        "due erano gli unici che quel generatore lasciava fuori. Quel che resta "
        "e' UNO: `\"ElonaPlus Custom-GX \"` (:413), l'operando di uno "
        "`sreplace`. "
        "ⓘ La storia di prima, che vale ancora: ERANO 10 FINO ALLA 140ª, e la "
        "dichiarazione della 135ª aveva ragione "
        ...
        "medal». Le tre che restavano allora erano `\"ElonaPlus Custom-GX \"` "
        "(:413) e i due `instr` scherzosi, sciolti poi dalla 142ª. "
